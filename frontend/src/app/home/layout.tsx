        ...
        <div>
            ...
            <div className="h-full px-3 pb-4 overflow-y-none bg-whit">
                <ul className="space-y-2 font-medium">
                    <li>
                        <Link href="/home/timeline" onClick={toggleSidebar} className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                    ...
                    <li>
                        <Link href="/home/search" onClick={toggleSidebar} className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                    ...
                    <li>
                        <Link href="/home/notifications" onClick={toggleSidebar} className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                    ...
                    <li>
                        <Link href="/home/profile/me" onClick={toggleSidebar} className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
